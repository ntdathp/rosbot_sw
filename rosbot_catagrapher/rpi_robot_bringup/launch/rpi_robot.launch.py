...
def generate_launch_description():
    pico_port = LaunchConfiguration('pico_port', default='/dev/ttyUSB0')
    rplidar_port = LaunchConfiguration('rplidar_port', default='/dev/ttyUSB1')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=['0.064', '0', '0.35', '0', '0', '0', 'base_link', 'laser'],
            output='screen'
        ),
    ])